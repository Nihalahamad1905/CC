$(document).ready(function() {
    ...
    $(".cou-menu").hover(function() {
        $(".cou-mm").fadeIn();
    });
    $(".cou-menu").mouseleave(function() {
        $(".cou-mm").fadeOut();
    });
    $(".tt-menu").hover(function() {
        $(".tt-mm").fadeIn();
    });
    $(".tt-menu").mouseleave(function() {
        $(".tt-mm").fadeOut();
    });
    $(".sbm-menu").hover(function() {
        $(".sbm-mm").fadeIn();
    });
    $(".sbm-menu").mouseleave(function() {
        $(".sbm-mm").fadeOut();
    });
    //MEGA MENU	
    $(".polic-menu").hover(function() {
        $(".polic-mm").fadeIn();
    });
    $(".polic-menu").mouseleave(function() {
        $(".polic-mm").fadeOut();
    });
